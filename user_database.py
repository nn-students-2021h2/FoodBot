...
def get_user_object(user_id: int) -> dict:
    ...
    try:
        ...
        result = dict(user_id=database_result[0][0], user_name=database_result[0][1], user_age=database_result[0][2],
                      user_sex=database_result[0][3], user_height=database_result[0][4],
                      user_weight=database_result[0][5], user_activity=database_result[0][6],
                      user_goal=database_result[0][7], user_calorie_norm=database_result[0][8],
                      user_protein_norm=database_result[0][9], user_fat_norm=database_result[0][10],
